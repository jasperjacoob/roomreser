...
<div class="main-content">
        <?php
            ...
            if(isset($_POST['edit_btn']))
            {
                ...
                $query = "SELECT * FROM tbl_faculty WHERE FacultyID='$FacultyID' ";
                $query_run = mysqli_query($connection,$query);
                foreach($query_run as $row){
        ?>

<form action="edit_faculty_acc.php" method="POST">
            <div>
                <h5>Faculty ID:</h5>
                <input type="text" id="FacultyID" name="edit_FacultyID" value="<?php echo $row['FacultyID'] ?>" placeholder="Enter Faculty ID: " readonly>
            </div>
            <div>
                <h5>Email Address:</h5>
        ...
        <a href="../admin_faculty.php" class="btn">cancel</a>
